...
class FITSetZeroExplainer(BaseExplainer):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.path = path
        self.log = logging.getLogger(FITSetZeroExplainer.__name__)
        if len(kwargs) > 0:
    ...
    def attribute(self, x, mask=None):
        """FIT attribution using zero for counterfactuals"""
        x = x.to(self.device)
        ...
        self.log.info("attribute_zero done")
        return score
